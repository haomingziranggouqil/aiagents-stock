...
from modules.longhubang.engine import LonghubangEngine
from modules.longhubang.pdf import LonghubangPDFGenerator
...
def run_longhubang_analysis(model="qwen3.5-plus", date=None, days=1):
    """运行龙虎榜分析"""
